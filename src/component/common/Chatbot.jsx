    ...
    <div className="chatbot-container">
      {!isOpen ? (
        <Button
          ...
          shape="circle"
          size="large"
          icon={<img src={chatBot || "/placeholder.svg"} alt="Bot" style={{ width: 24, height: 24 }} />}
          ...
          <div className="chatbot-header">
            <div className="chatbot-header-info">
              <div className="chatbot-avatar">
                <img src={chatBot || "/placeholder.svg"} alt="Bot" style={{ width: 24, height: 24 }} />
              </div>
              <span className="chatbot-title">Trợ lý ảo</span>
            </div>
            <Button type="text" icon={<CloseOutlined />} onClick={toggleChatbot} className="chatbot-close-btn" />
          </div>
