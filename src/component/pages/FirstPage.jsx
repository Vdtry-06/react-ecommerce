  ...
  const promoItems = [
    {
      ...
      textImage: "https://foodking.windstripedesign.ro/images/shape/burger-text.png",
      buttonText: "ORDER NOW",
    },
    {
      title: "BỮA ĂN NHANH",
      subtitle: "Mùi thơm hấp dẫn của những chiếc bánh mì kẹp thịt đang cháy",
      discount: "https://foodking.windstripedesign.ro/images/offer/50percent-off-3.png",
  ...
  useEffect(() => {
    const fetchHomeData = async () => {
      try {
        ...
        setDisplayedProducts(fetchedProducts.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage));
      } catch (error) {
    ...
    <Layout className="firt-layout">
      ...
      <div className="promo-section">
        <div className="promo-content">
          ...
          <Button type="primary" size="large" onClick={() => navigate("/cart")} className="promo-button">
            Đặt hàng ngay
          </Button>
        </div>
        <img
      ...
      <div className="about-section">
        ...
        <div className="about-content">
          ...
          <Text className="about-subtitle">
            Trải nghiệm ăn uống hoàn hảo với mọi món ăn được chế biến từ nguyên liệu tươi ngon, chất lượng cao. Đội ngũ của chúng tôi cam kết mang đến trải nghiệm độc đáo với âm nhạc và nghệ thuật tương tác.
          </Text>
          <br />
          <br />
          <Button type="primary" className="about-button" onClick={() => navigate("/")}>
      ...
      <Content className="firt-content2">
        ...
        >
          ...
          <div className="carousel-slide2 slide-2">
            ...
            <img src="https://foodking.windstripedesign.ro/images/about-food/potato.png" alt="Pizza Text" className="banner-image"/>
          </div>
      ...
      <div className="products-container-4" style={{ padding: '24px' }}>
        ...
        <div className="carousel-slide3 slide-3">
            ...
            <img src="https://foodking.windstripedesign.ro/images/food/grilled.png" alt="Grilled Food" className="banner-image"/>
            <img src="https://foodking.windstripedesign.ro/images/food/kfc.png" alt="Salad" className="banner-image" />
            <img src="https://foodking.windstripedesign.ro/images/com_hikashop/upload/shop-food/list/02.png" alt="Pizza" className="banner-image" />
            <img src="https://foodking.windstripedesign.ro/images/offer/50percent-off-2.png" alt="Offer" className="banner-image" />
            <img src="https://foodking.windstripedesign.ro/images/choose/01.png" alt="Delivery" className="banner-image" />
          </div>
        <div className="promo-section">
            ...
            {promoItems.map((item, index) => (
              <Col xs={24} sm={12} md={12} lg={12} key={index}>
                <Card
                  ...
                  cover={
                    <div className="promo-image-container">
                      <img src={item.image} alt={item.subtitle} className="promo-main-image" />
                      {item.textImage && <img src={item.textImage} alt="Text" className="promo-text-image" />}
                      {item.discount && <img src={item.discount} alt="Discount" className="promo-discount" />}
                    </div>
                  }
                  actions={[
                    <Button
                ...
                >
                  ...
                  {item.price && <Text className="promo-price">{item.price}</Text>}
                </Card>
              </Col>
            ))}
          </Row>
